...
class AllowedUsersRule(models.Model):
    ...
    all_corporate_users = models.BooleanField(default=False, verbose_name="All Corporate users?")
    all_individual_users = models.BooleanField(default=False, verbose_name="All individual users?")
