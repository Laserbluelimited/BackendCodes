...
class CorporateClient(models.Model):
    ...
    bill_name = models.CharField('billing_name', max_length=255, unique=True)
    bill_phone = models.IntegerField('billing_phone', unique=True)
    bill_email = models.EmailField('company_email', unique=True)
